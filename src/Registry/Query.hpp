...
namespace Astra
{
    ...
    template<typename... Ts> struct AnyOf;
    ...
    namespace QueryDetail
    {
        ...
        struct IsModifier<AnyOf<Ts...>> : std::true_type {};
        ...
        struct ExtractComponents<AnyOf<Ts...>, Rest...>
        {
        ...
        struct QueryClassifier
        {
            ...
            using AnyGroups = typename FilterByModifier<AnyOf, QueryArgs...>::type;
    ...
    template<typename T>
    concept ValidQueryArg = Component<T> || QueryDetail::IsModifier_v<T>;
